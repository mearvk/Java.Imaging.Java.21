...
import com.mearvk.imaging.FileType;
...
import com.mearvk.metadata.exif.ExifThumbnailDirectory;
import com.mearvk.metadata.file.FileSystemDirectory;
    ...
    static class MarkdownTableOutputHandler extends FileHandlerBase
    {
        ...
        static class Row
        {
            ...
            Row(@NotNull File file, @NotNull Metadata metadata, @NotNull String relativePath)
            {
                ...
                MetadataReader subIfdDir = metadata.getFirstDirectoryOfType(MetadataReader.class);
                ...
                if (subIfdDir != null) {
                    exifVersion = subIfdDir.getDescription(MetadataReader.TAG_EXIF_VERSION);
                    hasMakernoteData = subIfdDir.containsTag(MetadataReader.TAG_MAKERNOTE);
                }
                if (thumbDir != null) {
