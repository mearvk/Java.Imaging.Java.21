 ...
 */
package com.mearvk.metadata.exif;
...
import com.mearvk.imaging.tiff.TiffProcessingException;
import com.mearvk.imaging.tiff.TiffReader;
import com.mearvk.lang.BufferBoundsException;
import com.mearvk.lang.ByteArrayReader;
import com.mearvk.lang.Charsets;
import com.mearvk.lang.RandomAccessReader;
...
import com.mearvk.metadata.StringValue;
import com.mearvk.metadata.apple.AppleRunTimeReader;
import com.mearvk.metadata.exif.makernotes.*;
import com.mearvk.metadata.icc.IccReader;
import com.mearvk.metadata.iptc.IptcReader;
import com.mearvk.metadata.photoshop.PhotoshopReader;
import com.mearvk.metadata.tiff.DirectoryTiffHandler;
import com.mearvk.metadata.xmp.XmpReader;

/**
 * Implementation of {@link com.mearvk.imaging.tiff.TiffHandler} used for handling TIFF tags according to the Exif
 * standard.
 * <p>
...
public class ExifTiffHandler extends DirectoryTiffHandler
{
    ...
    public boolean tryEnterSubIfd(int tagId)
    {
        if (tagId == ExifDirectoryBase.TAG_SUB_IFD_OFFSET) {
            pushDirectory(MetadataReader.class);
            return true;
        }
        ...
        } else if (_currentDirectory instanceof MetadataReader) {
            if (tagId == MetadataReader.TAG_INTEROP_OFFSET) {
                                    ...
                                    final int byteCount) throws IOException
    {
        ...
        if (tagId == MetadataReader.TAG_MAKERNOTE && _currentDirectory instanceof MetadataReader) {
            return processMakernote(tagOffset, processedIfdOffsets, tiffHeaderOffset, reader);
        }

        // Custom processing for embedded IPTC data
        if (tagId == MetadataReader.TAG_IPTC_NAA && _currentDirectory instanceof ExifIFD0Directory) {
        ...
        if (tagId == MetadataReader.TAG_INTER_COLOR_PROFILE) {
        ...
        if (tagId == MetadataReader.TAG_PHOTOSHOP_SETTINGS && _currentDirectory instanceof ExifIFD0Directory) {
        ...
        if (tagId == MetadataReader.TAG_APPLICATION_NOTES && (_currentDirectory instanceof ExifIFD0Directory || _currentDirectory instanceof MetadataReader)) {
